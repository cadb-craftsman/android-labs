...
public class ContactsAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private ContactsAdapter.MyViewHolder target;

  @UiThread
  public ContactsAdapter$MyViewHolder_ViewBinding(ContactsAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ContactsAdapter.MyViewHolder target = this.target;
