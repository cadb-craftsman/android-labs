...
public class RemoteSearchActivity extends BaseActivity implements ContactsAdapterFilterable.ContactsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model.getRemoteContacts(disposable,"gmail", contactsList, mAdapter);
    }
